...
async function start(mode, cliFilters, options) {
	try {
		const { startVitest } = await import('./cli-api.BfdDOPPI.js').then(function (n) { return n.q; });
...
async function collect(mode, cliFilters, options) {
	try {
		const { prepareVitest, processCollected, outputFileList } = await import('./cli-api.BfdDOPPI.js').then(function (n) { return n.q; });
